            ...
            <div class="container p-0">
                <div class="row">
                    <div class="title-container col-12">
                        <h1><?php echo sprintf( __( '%s Search Results for ', 'qanat' ), $wp_query->found_posts ); echo esc_attr(get_search_query()); ?></h1>
                    </div>
                    <?php if (have_posts()) : ?>
                    <section class="col-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        <header>
                                            ...
                                            <span class="author" itemprop="author" itemscope itemptype="http://schema.org/Person"><?php _e('Publicado por:', 'qanat'); ?> <?php the_author_posts_link(); ?></span>
                                        </header>
                                        <p><?php the_excerpt(); ?></p>
                                        <a href="<?php the_permalink(); ?>" title="<?php _e('Leer Más', 'qanat'); ?>" class="btn btn-md btn-dark"><?php _e('Leer Más', 'qanat'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                    ...
                    <?php else: ?>
                    <section>
                        <h2><?php _e('Disculpe, su busqueda no arrojo ningun resultado', 'qanat'); ?></h2>
                        <h3><?php _e('Dirígete nuevamente al', 'qanat'); ?> <a href="<?php echo home_url('/'); ?>" title="<?php _e('Volver al Inicio', 'qanat'); ?>"><?php _e('inicio', 'qanat'); ?></a>.</h3>
                    </section>
                    <?php endif; ?>
                </div>
            </div>
